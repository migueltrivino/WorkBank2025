...
function ContactForm() {
  ...
  // 🔹 Ajuste handleAttachClick: toast si estamos en contacto
    ...
    // 🔹 renderInput con label flotante incluso si hay texto
    ...
    return (
      <div className={`${styles["wave-group"]} ${isFilled ? styles.filled : ""}`}>
        <input
          ...
          required={required}
          autoComplete="on" // permite que navegador complete
        />
        ...
        >
          <div className={styles.formContent}>
            <div className={styles.formFields}>
              ...
              {renderInput({ type: "text", name: "telefono", placeholder: "Número de Teléfono", required: false, splitWords: true })}
